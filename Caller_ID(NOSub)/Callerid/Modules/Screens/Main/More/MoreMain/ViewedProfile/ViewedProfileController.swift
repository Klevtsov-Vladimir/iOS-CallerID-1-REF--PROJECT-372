...
extension ViewedProfileController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        print(TimeInterval(viewedInfo.date[indexPath.row]))
        print(viewedInfo.date[indexPath.row])
        print(Date(timeIntervalSince1970: TimeInterval(viewedInfo.date[indexPath.row]) ?? 0))
