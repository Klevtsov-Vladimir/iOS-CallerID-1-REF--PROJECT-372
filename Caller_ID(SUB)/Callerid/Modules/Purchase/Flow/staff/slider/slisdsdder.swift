...
class SliderCellView: UIView {
    ...
    private var fontName: String = Coasanfidgudrdadtdidovns.getSubFontName()
    ...
    lazy var starIcon: UIImageView = {
       var image = UIImageView()
        image.image = UIImage(named: "starasdsad")
    ...
    override init(frame: CGRect) {
        ...
        cdasofnasdffdsifgdufrdsfedsfVsdfisdfdsfdsfdsfew()
        iutyuiytjfghhjfgrthgftytrfghfgh()
    }
    ...
    func cdasofnasdffdsifgdufrdsfedsfVsdfisdfdsfdsfdsfew() {
    ...
    func iutyuiytjfghhjfgrthgftytrfghfgh() {
