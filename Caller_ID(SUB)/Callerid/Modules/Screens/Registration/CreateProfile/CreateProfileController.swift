...
final class CreateProfileController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        eriwuytfdghsjkfdbhkjshjdfshjkdfsa()
    }
}
...
extension CreateProfileController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .picture:
            ...
            cell.pictureView.setImage(profile.avatarImage)
            cell.pictureView.setTitleText(row.title)
...
//MARK: - Setup
private extension CreateProfileController {
    func eriwuytfdghsjkfdbhkjshjdfshjkdfsa() {
        seturifniwwpUI()
        setupTable()
        iudahgfuiwreyagfuwieyrgfiuweygiuygiuyguiyguiguy()
    ...
    func iudahgfuiwreyagfuwieyrgfiuweygiuygiuyguiyguiguy() {
