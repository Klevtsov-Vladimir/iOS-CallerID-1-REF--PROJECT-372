...
final class PhoneVerifyController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dsuhiagfuihdasfuhiagshudfgewwuhd()
    }
...
//MARK: - Setup
private extension PhoneVerifyController {
    func dsuhiagfuihdasfuhiagshudfgewwuhd() {
        setukmkoprorkncpUI()
        setupTable()
        sdfahgdsufgudsagfyewuewuhww()
        ...
        continueView.callback = { [weak self] in
            ...
            if phoneNumberCustomDefaultRegion == nil {
                ...
                let confirmAction = UIAlertAction(title: "confirm".localized(), style: .default) { _ in
                    ...
                    TwilioManager.shared.sefbgrndSMS(phone: actualPhone.replacingOccurrences(of: "+", with: "")) { result in
                        DispatchQueue.main.async {
                            ...
                            case .success(_):
                                ...
                                DispatchQueue.main.async {
                                    ...
                                    CorasedasadRddealm.shared.ewqutyrweqgjhfdsjhvdfs(model: model)
                                }
    ...
    func sdfahgdsufgudsagfyewuewuhww() {
...
struct Phone {
    var phone: String?
    var countryInfo: Cousdnstsrsydffffrrrgdvnjvdjnvdjnv?
}
