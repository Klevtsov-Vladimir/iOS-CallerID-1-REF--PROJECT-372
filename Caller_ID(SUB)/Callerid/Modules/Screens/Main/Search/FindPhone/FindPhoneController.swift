...
final class FindPhoneController: UIViewController {
    ...
    private var phone = Phone(countryInfo: Cousdnstsrsydffffrrrgdvnjvdjnvdjnv(countries: countries.first?.countries) ) {
        didSet {
            showResView()
    ...
    override func viewDidLoad() {
        ...
        getContacts()
        ertyuijhgfdsertyuikjhgfdertyuijkjnhbvgfdrtyhjbvftyh()
    }
...
//MARK: - Setup
private extension FindPhoneController {
    func ertyuijhgfdsertyuikjhgfdertyuijkjnhbvgfdrtyhjbvftyh() {
        setuivfjndivpUI()
        setupTable()
        setupSearchView()
    ...
    func setupSearchView() {
        ...
        let country = countries.filter { country in
            return country.countries?.code == "US"//UserDefaults.standard.string(forKey: "RegistrationCountryCode")
        }
