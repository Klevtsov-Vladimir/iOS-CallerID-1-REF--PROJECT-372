...
//MARK: - Setup
private extension PhoneInfoController {
    func fyugvcfuighcitafduagasdagsdwq() {
        sewtuvdsjnkcnwekwwwwpUI()
        setupTable()
        fwehuwbhsdubdhsbhcbhchbhbudsbhudscsbdhucsbdhshbdhbsdsdhhubcbhcs()
...
//            self?.realm.updateValue(list: ["historyPhoneSearch": historyOld])
    ...
    func fwehuwbhsdubdhsbhcbhchbhbudsbhudscsbdhucsbdhshbdhbsdsdhhubcbhcs() {
