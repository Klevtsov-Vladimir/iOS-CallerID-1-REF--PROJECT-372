...
final class ResultsPhonesController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        gweughdcbhusdcuhbsdhbchsdbcjbsdjchsdchsbdjcbjsdbchdscbsjdhcbjhsdbcjsdbcdsbcjsdbcjhcbsdjhcdbhjbcs()
...
private extension ResultsPhonesController {
    func gweughdcbhusdcuhbsdhbchsdbcjbsdjchsdchsbdjcbjsdbchdscbsjdhcbjhsdbcjsdbcdsbcjsdbcjhcbsdjhcdbhjbcs() {
        setuposhifdboiwebUI()
        setupTable()
    }
